...
@section('content')
    <div class="px-6 py-10 mx-auto my-3 bg-white shadow lg:my-6 rounded-xl">
        <h1 class="mb-3 text-2xl font-bold lg:text-4xl">Tambah Skill</h1>
            ...
            <form action="{{route('user.skill.store')}}" method="post">
                ...
                <div class="flex flex-col gap-3 md:flex-row">
                    <div class="w-full md:w-3/4">
                        ...
                        <input type="text" name="skill" required class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-100 border border-gray-100 rounded-md md: focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:bg-white">
                    </div>
